...
void lbm_init(void)
{
	...
	lr1110_system_version_t lr1110_ver;
	lr1110_system_get_version(modem_radio->ral.context,&lr1110_ver);
	SYS_LOG_INFO("lr1110 version:hw=%x,type=%x,fw=%x\r\n",lr1110_ver.hw,lr1110_ver.type,lr1110_ver.fw);
	
}
void lbm_lorawan_init(void)
{

	uint8_t dev_eui[8] = { 0x08,0x06,0x08,0xa1,0xa2,0xa3,0xa4,0xa5};
	uint8_t app_eui[8] = { 0x52,0x69,0x73,0x69,0x6e,0x67,0x48,0x46};
